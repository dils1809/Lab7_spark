...
# ---------------------------------------------------------------------------
# Extensión: armonización robusta, auditoría de calidad y filtros por paso.
# Las funciones de arriba se conservan sin cambios; estas se usan desde el
# notebook para poder contabilizar cada exclusión y validar contra el diccionario.
# ---------------------------------------------------------------------------
